...
"""
edx-recommendations documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'edx-recommendations',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/openedx/edx-recommendations",
...
#
# html_title = 'edx-recommendations v0.1.0'
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'edx-recommendations'),
                os.path.join(root_path, 'edx-recommendations/migrations')])
